...
export const GET_ARTICLES_BY_CATEGORIES_REQUEST = "GET_ARTICLES_BY_CATEGORIES_REQUEST";
export const GET_ARTICLES_BY_CATEGORIES_SUCCESS = "GET_ARTICLES_BY_CATEGORIES_SUCCESS";
export const GET_ARTICLES_BY_CATEGORIES_FAIL = 'GET_ARTICLES_BY_CATEGORIES_FAIL';
